    ...
    <link href="../src/assets/css/light/widgets/modules-widgets-vlm.css" rel="stylesheet" type="text/css" />
    ...
    <link href="../src/assets/css/dark/components/modal.css" rel="stylesheet" type="text/css">
    <!--  END TODO LIST STYLE FILE  -->

    <!-- BEGIN CALENDAR LEVEL STYLE -->
    ...
    <link href="../src/assets/css/dark/components/modal.css" rel="stylesheet" type="text/css">
    <!-- END CALENDAR LEVEL STYLE -->

    <!-- BEGIN CONTACTS LEVEL STYLES -->
    <link href="../src/assets/css/light/components/modal.css" rel="stylesheet" type="text/css">
