...
$id_user = $_SESSION['id_user'];
$view    = "SELECT * FROM tugas WHERE id_user = '$id_user'";
...
if (isset($_POST['addTask-btn'])){
    ...
    $sql   = "INSERT INTO tugas (id_user, judul, deskripsi, tenggat) VALUES ('$id_user',
                                                                             '$taskName',
                                                                             '$taskDesc',
                                                                             '$tenggat')";
...
<?php
    if (isset($_POST['updTask-btn'])){
        ...
        $tenggat = $_POST['tenggatUpd'];

        $sqlupdate = "UPDATE tugas SET judul = '$taskName', 
                                  deskripsi = '$taskDesc',
                                  tenggat  = '$tenggat' 
                                   WHERE id = '$taskId'";

        $queryupd  = mysqli_query($koneksi, $sqlupdate);
        header("location: todoList.php");
    }
?>
<?php
    if (isset($_POST['delTask'])){
        ...
        $sqldel    = "DELETE FROM tugas WHERE id = '$idTask'";
        $queryddel = mysqli_query($koneksi, $sqldel);
        header("location: todoList.php");
    }
?>
...
<head>
    ...
    <title>Daftar Tugas - Nolico</title>
</head>
<body class="layout-boxed ">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <div class="mail-box-container">
                                ...
                                <div class="tab-title">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-12 text-center">
                                            ...
                                            <h5 class="app-title">Daftar Tugas</h5>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-12 ps-0">
                                            <div class="todoList-sidebar-scroll mt-4">
                                                <ul class="nav nav-pills d-block" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link list-actions active" id="all-list" data-toggle="pill" href="#pills-inbox" role="tab" aria-selected="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3" y2="6"></line><line x1="3" y1="12" x2="3" y2="12"></line><line x1="3" y1="18" x2="3" y2="18"></line></svg> Tugas <span class="todo-badge badge"></span></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link list-actions" id="todo-task-done" data-toggle="pill" href="#pills-sentmail" role="tab" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-thumbs-up"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path></svg> Selesai <span class="todo-badge badge"></span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-12">
                                        <a class="btn btn-secondary" id="addTask" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Tambah Tugas</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="todo-inbox" class="accordion todo-inbox">
                                    <div class="search">
                                        <input type="text" class="form-control input-search" placeholder="Cari Tugas...">
                                            ...
                                            <div class="todo-item-inner">
                                                <div class="n-chk text-center">
                                                    <div class="form-check form-check-primary form-check-inline mt-1 me-0" data-bs-toggle="collapse" data-bs-target>
                                                        <input data data-dead="<?= $row['tenggat']; ?>" id="<?php echo $row['id']; ?>" class="form-check-input inbox-chkbox" type="checkbox">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="todo-content" 
                                                       ...
                                                       data-dead   = "<?= $row['tenggat']; ?>">
                                                    <a class="todoClick"></a>
                                                    <h5 class="todo-heading" data-todoHeading=""><?php echo $row['judul']; ?></h5>
                                                </div>
                                                <div class="action-dropdown custom-dropdown-icon">
                                                    <div style="display: flex; flex-direction: row;">
                                                    <h6 style="margin-right: 15px; white-space: nowrap; margin-top: 5px;">(<?php echo $row['tenggat']; ?>)</h6>
                                                    <div class="dropdown">
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="d-flex  mail-subject">
                                                            ...
                                                            <div class="w-100">
                                                                ...
                                                                <input class="form-control" style="margin-top: 15px;" type="date" name="tenggat">
                                                                <span class="validation-text"></span>
                                                            </div>
                                                        </div>
                                                </div>
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="d-flex  mail-subject">
                                                            ...
                                                            <div class="w-100">
                                                                ...
                                                                <div class="tenggatupdate">
                                                                <input type="date" id="dateUpdate" class="form-control" style="margin-top: 15px;" name="tenggatUpd">
                                                                </div>
                                                                <span class="validation-text"></span>
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        if (currentURL.indexOf("todoList.php") !== -1) {
