                            ...
                            <div class="user-profile">
                                <div class="widget-content widget-content-area p-4">
                                    ...
                                    <div class="text-center user-info">
                                        <img style="border-radius: 50%; width: 100px; height: 100px; object-fit: cover;" src="<?php echo ($row['foto'] != "") ? $row['foto'] : "../src/assets/img/user.png"; ?>" alt="avatar">
                                        <p class=""><?= $row['nama']; ?></p>
                                    </div>
